import{c as l}from"./index-t3EYozG5.js";import{f as c}from"./index-DJpgPZp3.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const le=l("User",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]),h=`---
...
By proving that a learning-based approach is more effective than static or rule-based systems, this work paves the way for a new generation of applications that don't just serve us, but truly understand and react to us.`,q=`---
...
In a world where autonomous attacks operate at machine speed and models can be nerfed overnight, sovereignty is not the cheapest token. It is the token you can still produce when the provider is unavailable, unreliable, or unwilling.`,W=`---
...
By respecting the different natures of software and machine learning development while building strong communication bridges, **Agile4MLS** provides a clear and effective roadmap for any organization looking to successfully build and deploy ML-enabled systems.`,K=`---
...
The authors plan to implement this architecture for the science fair use case, using technologies like **Apache Kafka**, **Istio**, **Kubernetes**, and **Keras**. This will allow them to measure its real-world effectiveness in terms of prediction accuracy, energy savings for devices, and the successful achievement of user goals. This work provides a strong blueprint for the next generation of intelligent, resilient IoT systems.`,Q=`---
...
That's the harder problem. It's also the more interesting one.`,N=`---
...
The researchers plan to extend this work to other domains like Natural Language Processing (NLP) and explore its use in edge computing. This research is a valuable contribution to the ongoing effort to make AI not just more powerful, but also more responsible.`,Y=`---
...
The study concludes by suggesting that future work should explore microservice-based architectures, which could offer an even finer-grained approach to scaling and optimizing individual components of an IoT platform.`,X=`---
 ...
 *"A computer can never be held accountable, therefore a computer must never make a management decision."*`,Z=`---
...
While the initial study shows that LLMs have great potential for automating AKM tasks, it also highlights the need for further research to reach human-level proficiency. The ultimate goal is a user-friendly system that simplifies documentation, prevents knowledge vaporization, and empowers teams to make better, more informed decisions.`,te=`---
...
The future of **software architecture for ML-based systems** lies in creating unified frameworks, processes, and tools that treat intelligent components not as external black boxes but as first-class citizens of the architecture. The role of the software architect will evolve to that of a coordinator who understands both worlds—fluent in both programmatic and probabilistic thinking—and can design systems that are not just built, but are built to learn and evolve.`,se=`---
...
`,a=Object.assign({"../blog/2103.07950v2.md":h,"../blog/2109.07900v1.md":d,"../blog/2109.10073v1.md":m,"../blog/2308.09960v1.md":u,"../blog/2402.05466v1.md":g,"../blog/2402.06351v1.md":p,"../blog/2403.01709v1.md":f,"../blog/2404.04572v1.md":y,"../blog/2404.09866v1.md":w,"../blog/2404.11411v1.md":v,"../blog/2501.08243v1.md":b,"../blog/2501.14165v1.md":T,"../blog/2501.17028v1.md":k,"../blog/2503.13310v2.md":A,"../blog/2504.08207v1.md":_,"../blog/2504.19277v1.md":M,"../blog/2509.10099v1.md":L,"../blog/2512.04702v2.md":I,"../blog/2512.09543v2.md":S,"../blog/2512.12791v2.md":x,"../blog/2601.06456v1.md":E,"../blog/3344948.3344962.md":P,"../blog/3477314.3507146.md":D,"../blog/3494322.3494329.md":R,"../blog/3565472.3595614.md":C,"../blog/3593227.md":q,"../blog/3605098.3635942.md":F,"../blog/3617650.3624936.md":z,"../blog/3643915.3644105.md":O,"../blog/Owning Your Intelligence: The Case for Sovereignty.md":B,"../blog/a_machine_learning_driven_approach_for_proactive_decision_ma.md":W,"../blog/agile4mlsleveraging_agile_practices_for_developing_machine_learning_enabled_systems_an_industrial_experience.md":H,"../blog/architecting_digital_twin_for_smart_city_systems_a_case_study.md":K,"../blog/architecting_digital_twins_for_intelligent_transportation_systems.md":G,"../blog/can_llms_generate_architectural_design_decisions___an_exploratory_empirical_study.md":j,"../blog/dagrep.13.7.166.md":U,"../blog/data_driven_adaptation_in_microservice_based_iot_architectures.md":V,"../blog/digitaltwinslikhit.md":Q,"../blog/ecomls_a_self_adaptation_approach_for_architecting_green_ml_enabled_systems.md":N,"../blog/edgemlbalancer_a_self_adaptive_approach_for_dynamic_model_switching_on_resource_constrained_edge_devices.md":Y,"../blog/engineering_end_to_end_remote_labs_using_iot_based_retrofitting.md":J,"../blog/exploratory_study_of_onem2m_based_interoperability_architectures_for_iot_a_smart_city_perspective.md":$,"../blog/jarvis-architecture-of-autonomy.md":X,"../blog/leaf.md":Z,"../blog/leveraging_generative_ai_for_architecture_knowledge_management.md":ee,"../blog/leveraging_llms_for_dynamic_iot_systems_generation_through_mixed_initiative_interaction.md":te,"../blog/poseidon.md":ne,"../blog/scalable_and_interoperable_distributed_architecture_for_iot_in_smart_cities.md":ae,"../blog/software_architecture_for_ml_based_systems_what_exists_and_what_lies_ahead.md":ie,"../blog/towards_self_adaptive_machine_learning_enabled_systems_through_qos_aware_model_switching.md":se});console.log("Loaded markdown files:",Object.keys(a));const i={};for(const t in a){const n=t.match(/([\\/])([^\\/]+?)(?:\.md)?$/);if(!n)continue;const e=n[2],s=a[t],{attributes:o,body:r}=c(s);i[e]={metadata:o,content:r}}const ce=Object.entries(i).map(([t,n])=>{const e=n.metadata||{};return{slug:t,title:e.title||"Untitled Post",excerpt:e.excerpt||"",date:e.date||new Date().toISOString(),author:e.author||"Unknown Author",category:e.category||"Uncategorized",thumbnail:e.thumbnail}}).sort((t,n)=>new Date(n.date).getTime()-new Date(t.date).getTime());export{le as U,ce as a,i as b};
